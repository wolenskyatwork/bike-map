...
// Responsible for searching media library, making calls to the
// API and instructing the redux-saga middleware on the next line
// of action, for success or failure operation.
